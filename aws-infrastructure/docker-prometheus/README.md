...
```
docker tag prometheus-custom 241523129597.dkr.ecr.eu-central-1.amazonaws.com/monitoring:prometheus
```

```
docker push 241523129597.dkr.ecr.eu-central-1.amazonaws.com/monitoring:prometheus
```