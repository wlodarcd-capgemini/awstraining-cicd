...
```
docker tag filebeat-custom 241523129597.dkr.ecr.eu-central-1.amazonaws.com/monitoring:filebeat
```

```
docker push 241523129597.dkr.ecr.eu-central-1.amazonaws.com/monitoring:filebeat
```